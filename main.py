...
book_list = bookRecommender.create_bList(genre)
chosen_book = bookRecommender.choose_book(book_list)
another_list = bookRecommender.another_books(book_list, chosen_book)
today_book = bookRecommender.get_bInfo(chosen_book)
add_books = []
for another in another_list:
    a_book = bookRecommender.get_bInfo(another)
    add_books.append(a_book)
